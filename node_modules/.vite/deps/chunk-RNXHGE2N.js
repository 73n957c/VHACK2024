...
function useTabPanel(_ref) {
  ...
  const context = (0, import_react8.useContext)(TabContext_default);
  if (!context)
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react9.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react9.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var TabContent = React7.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-RNXHGE2N.js.map
